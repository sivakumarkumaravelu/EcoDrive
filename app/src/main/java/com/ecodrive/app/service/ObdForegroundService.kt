...
/**
 * Foreground service to keep OBD-II data collection running
 * while the app is in the background or the screen is off.
 * This ensures continuous driving pattern monitoring during a trip.
 */
@AndroidEntryPoint
class ObdForegroundService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL_ID)
            ...
            .setContentText("Monitoring your driving patterns…")
